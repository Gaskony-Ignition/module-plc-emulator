...
2. **Drag and drop** your L5K, JSON, or CSV file onto the upload zone
...
1. Open your PLC file (L5K, JSON, CSV) in a text editor
...
> **L5X is not supported.** If you have a `.l5x` (Studio 5000 XML export), re-export
> the program as an L5K file and upload that instead — uploading a `.l5x` is rejected.
> L5X support was removed in 11.0.0.
...
- Upload `LogixPLCEmulator-11.1.2.modl`
