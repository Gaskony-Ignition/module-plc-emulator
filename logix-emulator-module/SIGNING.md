...
Alias: plcsimulator
Password: REDACTED-DEV-PASSWORD (PUBLIC - development only)
```
...
The keystore password (`REDACTED-DEV-PASSWORD`) is **PUBLIC** and committed to the repository. This is intentional for:
...
keytool -genkeypair \
    ...
    -storepass REDACTED-DEV-PASSWORD \
...
| Password | `gaskony2024` | `REDACTED-DEV-PASSWORD` |
