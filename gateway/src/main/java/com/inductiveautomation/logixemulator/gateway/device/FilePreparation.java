 ...
 *   <li>Pick the right parser (L5K for the {@code rockwell} type, falling back
 *       to extension detection).</li>
...
public final class FilePreparation {
     ...
     *
     * <p>L5X was removed 27/07/2026 (maintainer decision — L5K is the only supported
     * Rockwell format). An {@code .l5x} left in the data dir by a pre-11.0.0 install is
     * therefore no longer picked up on restart; the device reports no file until an L5K
     * is uploaded. See CHANGELOG "Removed".</p>
     */
    private static final String[] PLC_EXTENSIONS =
        { ".L5K", ".l5k", ".json", ".JSON", ".csv", ".CSV" };
