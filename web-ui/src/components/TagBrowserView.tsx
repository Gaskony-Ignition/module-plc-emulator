          ...
          <div className="tbv-tree-body" key={renderKey}>
            {rootTags.length === 0 ? (
              <div className="tbv-empty">
                ...
                <div className="tbv-empty-sub">Upload an L5K file to populate tags</div>
              </div>
            ) : (
          ...
          >
            {currentTags.length === 0 && !loadingFlat ? (
              <div className="tbv-empty">
                ...
                <div className="tbv-empty-sub">{debouncedSearch ? 'Try a different search term' : 'Upload an L5K file to populate tags'}</div>
              </div>
            ) : (
              <>
                {currentTags.map((tag) =>
